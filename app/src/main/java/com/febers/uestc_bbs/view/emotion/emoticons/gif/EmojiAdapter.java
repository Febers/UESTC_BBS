package com.febers.uestc_bbs.view.emotion.emoticons.gif;
...
public class EmojiAdapter extends BaseAdapter {
    ...
    public EmojiAdapter(Context context, int emotionLayoutWidth, int emotionLayoutHeight, int startIndex) {
        ...
        float perWidth = emotionLayoutWidth * 1f / EmotionManager.getInstance().getEmojiColumn();
        mPerHeight = mEmotionLayoutHeight * 1f / EmotionManager.getInstance().getEmojiRow();
    ...
    public int getCount() {
        ...
        count = Math.min(count, EmotionManager.getInstance().getEmojiPerPage() + 1);
        return count;
    }
