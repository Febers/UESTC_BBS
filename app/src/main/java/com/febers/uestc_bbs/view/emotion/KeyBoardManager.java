...
import com.febers.uestc_bbs.view.emotion.listeners.OnMultiFixClickListener;
import com.febers.uestc_bbs.view.emotion.utils.EmoticonUtils;
import com.febers.uestc_bbs.view.emotion.view.EmotionEditText;
...
public class KeyBoardManager {
    ...
    private EmotionView mEmotionView; //表情布局
    ...
    private KeyBoardManager bindToEditText(final EmotionEditText editText) {
        mEditText = editText;
        ...
        mEditText.setBackPressedListener(new EmotionEditText.IBackPressedListener() {
            @Override
     ...
     */
    public KeyBoardManager setEmotionView(EmotionView emotionView) {
        ...
        EmotionManager.getInstance().manage(mEmotionView);
