...
class PostOptionBottomSheet(context: Context, style: Int, private val itemClickListener: OptionClickListener):
    ...
    private fun initView() {
        ...
        optionItemAdapter.setOnItemClickListener { viewHolder, optionItemBean, i ->
            ...
            if (i == ITEM_SHARE_POST) {
                ...
                val clipData = ClipData.newPlainText("uestc_bbs_clip_data", "复制的内容")
