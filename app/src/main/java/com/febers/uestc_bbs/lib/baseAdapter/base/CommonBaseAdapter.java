...
import com.febers.uestc_bbs.lib.baseAdapter.interfaces.OnItemChildClickListener;
import com.febers.uestc_bbs.lib.baseAdapter.interfaces.OnItemClickListener;
import com.febers.uestc_bbs.lib.baseAdapter.interfaces.OnItemLongClickListener;
...
public abstract class CommonBaseAdapter<T> extends BaseAdapter<T> {
    ...
    protected int getViewType(int position, T data) {
        return com.febers.uestc_bbs.lib.baseAdapter.base.BaseAdapter.TYPE_COMMON_VIEW;
    }
