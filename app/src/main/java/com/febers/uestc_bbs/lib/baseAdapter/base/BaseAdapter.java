package com.febers.uestc_bbs.lib.baseAdapter.base;
...
import com.febers.uestc_bbs.lib.baseAdapter.Util;
import com.febers.uestc_bbs.lib.baseAdapter.ViewHolder;
import com.febers.uestc_bbs.lib.baseAdapter.interfaces.OnLoadMoreListener;
...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void onLoadMore2(RecyclerView recyclerView) {
        NestedScrollView nestedScrollView = null;
        if (recyclerView.getParent() instanceof NestedScrollView) {
            nestedScrollView = (NestedScrollView) recyclerView.getParent();
        } else if (recyclerView.getParent().getParent() instanceof NestedScrollView) {
            nestedScrollView = (NestedScrollView)recyclerView.getParent().getParent();
        }
