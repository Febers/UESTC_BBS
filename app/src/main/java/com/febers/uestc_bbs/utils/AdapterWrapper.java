/*
 * Created by Febers at 18-8-17 上午7:22.
 * Copyright (c). All rights reserved.
 * Last modified 18-8-17 上午7:22.
 */
...
public class AdapterWrapper extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_LOAD) {
            if (mWrapperHolder == null) {
                mWrapperHolder = new WrapperHolder(View.inflate(parent.getContext(), R.layout.layout_loading, null));
            }
    ...
    class WrapperHolder extends RecyclerView.ViewHolder {
        ...
        TextView mLoadTv = itemView.findViewById(R.id.item_load_tv);

        ProgressBar mLoadPb = itemView.findViewById(R.id.item_load_pb);
