...
public class StatusBarUtil {
     ...
     * @param statusBarColor 需要设置的状态栏的颜色
     * @param withoutUseStatusBarColor 是否不需要使用状态栏为暗色调
     */
    public static void setStatusBar(Activity activity, boolean useThemeStatusBarColor, int statusBarColor, boolean withoutUseStatusBarColor) {
